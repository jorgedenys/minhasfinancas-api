...
public class LancamentoServiceImpl implements LancamentoService {
	...
	public Lancamento atualizar(Lancamento lancamento) {
		// Garantindo que irei atualizar um LANCAMENTO com ID. Senão, irá levantar uma exceção.
	...
	public void deletar(Lancamento lancamento) {
		// Garantindo que irei excluir um LANCAMENTO com ID. Senão, irá levantar uma exceção.
		Objects.requireNonNull(lancamento.getId());
		repository.delete(lancamento);
	}

	@Override
	// Spring framework irá fazer umas otimizações em nossa consulta utilizando READONLY = TRUE
	@Transactional( readOnly = true ) 
	public List<Lancamento> buscar(Lancamento lancamentoFiltro) {
		// Busca as informações que estão populadas dentro de lançamento filtro e irá
		// realizar as configurações para quando for passado o objeto EXAMPLE, só considere
		// as informações que foram populadas
